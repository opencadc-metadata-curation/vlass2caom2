...
def test_validator(http_mock, caps_mock, tap_mock):
    ...
    response.iter_content.return_value = \
        [b'<?xml version="1.0" encoding="UTF-8"?>\n'
         ...
         b'<TABLEDATA>\n'
         b'<TR>\n'
         b'<TD>ad:VLASS/VLASS1.1.ql.T01t01.J000228-363000.10.2048.v1.I.'
         b'iter1.image.pbcor.tt0.rms.subim.fits</TD>\n'
         b'</TR>\n'
         b'<TR>\n'
         b'<TD>ad:VLASS/VLASS1.1.ql.T01t01.J000228-363000.10.2048.v1.I.iter1.'
         b'image.pbcor.tt0.subim.fits</TD>\n'
         b'</TR>\n'
         b'<TR>\n'
         b'<TD>ad:VLASS/VLASS1.1.ql.T01t01.J000230-373000.10.2048.v1.I.iter1.'
         b'image.pbcor.tt0.rms.subim.fits</TD>\n'
         b'</TR>\n'
         b'</TABLEDATA>\n'
         b'</DATA>\n'
         b'</TABLE>\n'
