...
ARG FINDER_PATH=/usr/local/lib/python3.11/site-packages/footprintfinder.py
...
RUN pip install git+https://github.com/${OPENCADC_REPO}/vlass2caom2@${OPENCADC_MAIN_BRANCH}#egg=vlass2caom2
